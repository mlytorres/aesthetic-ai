...
class AffiliatePayoutReleasedMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: "Payment sent — {$this->formattedAmount} from {$this->tenant->name}",
        );
    }

    public function content(): Content
    {
        return new Content(view: 'emails.affiliate-payout-released');
    }
