...
class AffiliatePayoutApprovedMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: "Payout approved — {$this->formattedAmount} from {$this->tenant->name}",
        );
    }

    public function content(): Content
    {
        return new Content(view: 'emails.affiliate-payout-approved');
    }
