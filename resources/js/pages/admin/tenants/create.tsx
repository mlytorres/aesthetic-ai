...
export default function CreateTenant({ plans }: Props) {
    ...
    const handleProcedureToggle = (value: string) => {
        setData(
            'procedures',
            data.procedures.includes(value)
        ...
        <>
            ...
            <div className="max-w-2xl space-y-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    {/* Clinic Details */}
                    <div className="space-y-4 rounded-lg border border-sidebar-border/50 bg-card p-6">
                        ...
                        <div className="grid gap-2">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {PROCEDURES.map((proc) => {
                                    const active = data.procedures.includes(
                                        proc.value,
                                    );
                    ...
                    <div className="space-y-4 rounded-lg border border-sidebar-border/50 bg-card p-6">
                        ...
                        <p className="text-sm text-muted-foreground">
                            ...
                            and an invitation email sent to this address.
                        </p>
                    ...
                    <Button
                        type="submit"
                        disabled={processing}
                        className="w-full bg-[#0E9E8E] font-semibold text-[#0A0A0F] hover:bg-[#0E9E8E]/90"
                    >
                        {processing
                            ? 'Creating Clinic...'
