...
function actionColor(action: string): string {
    if (action.includes('export') || action.includes('viewed')) {
    ...
    if (action.includes('login') || action.includes('impersonat')) {
                ...
                <div className="flex items-start justify-between">
                    <div>
                        ...
                        <p className="mt-0.5 text-sm text-muted-foreground">
                            ...
                            {entries.total.toLocaleString()} entries
                        </p>
                    </div>
                </div>
