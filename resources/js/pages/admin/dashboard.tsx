            ...
            <div className="space-y-8 p-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        <Link
                            ...
                            className="rounded-lg border border-border px-3 py-1.5 text-sm text-muted-foreground transition-colors hover:border-[#0E9E8E]/40 hover:text-foreground"
                        >
                            Audit log →
                        </Link>
                        <Link
                ...
                <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
                    <StatCard
                        ...
                        sub={`${stats.total_clinics} total incl. deactivated`}
                        icon={Building2}
                        accent
                    />
                    <StatCard
                        label="On Free Trial"
                        value={stats.on_trial}
                        sub={`${stats.trial_expiring_this_week} expiring this week`}
                        icon={FlaskConical}
                        warn={stats.trial_expiring_this_week > 0}
                    />
                    <StatCard
                        label="New This Week"
                ...
                <div className="grid grid-cols-3 gap-4">
                    <StatCard
                        ...
                        value={stats.evals_today}
                        icon={Activity}
                        accent
                    />
                    <StatCard
                        label="Evaluations This Week"
                        value={stats.evals_this_week}
                        icon={Activity}
                    />
                    <StatCard
                        label="Evaluations All Time"
                        value={stats.evals_total.toLocaleString()}
                        icon={Activity}
                    />
                </div>
                                ...
                                <div key={b.slug}>
                                    ...
                                    <div className="h-1.5 rounded-full bg-muted/40">
                                        <div
                                            ...
                                            style={{
                                                width: `${(b.count / totalPlanned) * 100}%`,
                                            }}
                                        />
                                    </div>
                                </div>
                                ...
                                >
                                    <div className="min-w-0">
                                        <Link
                                            ...
                                            className="truncate text-sm font-medium text-foreground transition-colors hover:text-[#0E9E8E]"
                                        >
                                            {t.name}
                                        </Link>
