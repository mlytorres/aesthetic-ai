    ...
    return (
        <div className="py-6">
            ...
            <div className="mt-8 space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        value={contact.name}
                        onChange={set('name')}
                        className="w-full rounded-xl border border-white/10 bg-[#111118] px-4 py-3 text-sm text-[#F5F0E8] placeholder-white/25 focus:border-[#C9A84C]/60 focus:outline-none focus:ring-1 focus:ring-[#C9A84C]/30 transition-colors"
                    />
                </div>
            ...
            <div className="mt-5 flex items-start gap-3 rounded-xl border border-white/5 bg-white/[0.02] px-4 py-3">
                <svg className="mt-0.5 h-4 w-4 shrink-0 text-[#C9A84C]" viewBox="0 0 24 24" fill="none">
                    <path
