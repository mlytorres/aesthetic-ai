...
const PhotoCapture: FC<Props> = ({
    ...
    return (
        <div className="py-6">
            ...
            {/* Quality tips */}
            <div className="mt-4 rounded-xl border border-[#C9A84C]/20 bg-[#C9A84C]/5 px-4 py-3">
                <p className="text-xs font-semibold text-[#C9A84C] mb-1">📸 Photo tips</p>
        ...
        >
            ...
            <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-lg bg-white/5">
                {uploaded?.local_url && !uploaded.uploading ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center">
                        <svg className="h-5 w-5 animate-spin text-[#C9A84C]" viewBox="0 0 24 24" fill="none">
            ...
            <div className="flex-1 min-w-0">
                ...
                {uploaded?.error ? (
                    ...
                    <p className="text-xs text-[#C9A84C] mt-0.5">Uploaded ✓</p>
                ) : (
