...
export const translations: Translations = {
    en: {
        ...
        'procedure.subtitle': 'Select the procedure you\'re considering to begin your personalized AI evaluation.',
        ...
        'photos.subtitle': 'Clear, well-lit photos help our AI deliver the most accurate evaluation. All photos are encrypted and HIPAA-protected.',
        ...
        'photos.webcam_instructions': 'Position your face in the center of the frame and hold still.',
        ...
        'contact.subtitle': 'We\'ll use this to send your evaluation results and for your coordinator to reach you.',
        ...
        'contact.phone_hint': 'Optional. Used only to contact you about your evaluation.',
        'contact.continue_cta': 'Continue',

        // Consent & review
        'consent.title': 'Review & confirm',
        'consent.subtitle': 'Please review your details and grant the required consents to complete your evaluation submission.',
        ...
        'consent.hipaa_text': 'I acknowledge that I have been informed of my rights under the Health Insurance Portability and Accountability Act (HIPAA). My protected health information may be used for treatment and evaluation purposes.',
        'consent.terms_label': 'Terms of Service',
        'consent.terms_text': 'I agree to the Terms of Service. I understand that this evaluation is informational and does not constitute medical advice. A licensed physician will review my case.',
        'consent.photo_label': 'AI Photo Analysis Consent',
        'consent.photo_text': 'I consent to my photos being analysed by artificial intelligence to assist in generating my evaluation report. Photos are encrypted and accessible only to clinic staff.',
        'consent.sms_label': 'SMS Notifications',
        'consent.sms_text': 'I consent to receive text messages regarding my evaluation and consultation updates. Message and data rates may apply.',
        'consent.optional_badge': 'optional',
        'consent.submit_cta': 'Submit My Evaluation ✓',
        'consent.submitting': 'Submitting…',
        'consent.disclaimer': 'By submitting, you confirm that all information provided is accurate and truthful.',

        // Success
        'success.title': 'Evaluation received!',
        'success.subtitle': 'Thank you. Your AI-powered evaluation is underway.',
        'success.next_steps_heading': 'What happens next',
        'success.step1_title': 'AI Analysis',
        'success.step1_body': 'Our AI is processing your photos and quiz answers to generate your personalized evaluation report.',
        'success.step2_title': 'Coordinator Review',
        'success.step2_body': 'A clinic coordinator will review your evaluation and reach out within 1 business day.',
        'success.step3_title': 'Your Results',
        'success.step3_body': 'You\'ll receive your Beauty Roadmap report by email once your evaluation is complete.',

        // Footer
        'footer.hipaa_notice': 'Your information is encrypted and protected under HIPAA.',
    ...
    es: {
        ...
        'procedure.subtitle': 'Selecciona el procedimiento que estás considerando para comenzar tu evaluación de IA personalizada.',
        ...
        'photos.subtitle': 'Las fotos claras y bien iluminadas ayudan a nuestra IA a proporcionar la evaluación más precisa. Todas las fotos están encriptadas y protegidas por HIPAA.',
        ...
        'photos.quality_poor': 'Calidad deficiente — intenta con mejor iluminación',
        'photos.uploading': 'Subiendo…',
        'photos.continue_cta': 'Continuar con {count} foto(s)',
        'photos.webcam_title': 'Tomar una foto',
        'photos.webcam_instructions': 'Coloca tu cara en el centro del encuadre y mantente quieto.',
        ...
        'contact.subtitle': 'Usaremos esto para enviar tus resultados de evaluación y para que tu coordinador pueda contactarte.',
        ...
        'contact.phone_placeholder': '+1 (555) 000-0000',
        'contact.phone_hint': 'Opcional. Solo se usa para contactarte sobre tu evaluación.',
        'contact.continue_cta': 'Continuar',

        // Consent & review
        'consent.title': 'Revisión y confirmación',
        'consent.subtitle': 'Por favor revisa tus datos y otorga los consentimientos requeridos para completar el envío de tu evaluación.',
        ...
        'consent.hipaa_text': 'Reconozco que he sido informado de mis derechos bajo la Ley de Portabilidad y Responsabilidad de Seguros de Salud (HIPAA). Mi información de salud protegida puede ser utilizada para fines de tratamiento y evaluación.',
        'consent.terms_label': 'Términos de Servicio',
        'consent.terms_text': 'Acepto los Términos de Servicio. Entiendo que esta evaluación es informativa y no constituye consejo médico. Un médico con licencia revisará mi caso.',
        'consent.photo_label': 'Consentimiento de Análisis de Fotos por IA',
        'consent.photo_text': 'Doy mi consentimiento para que mis fotos sean analizadas por inteligencia artificial para ayudar a generar mi informe de evaluación. Las fotos están encriptadas y son accesibles solo para el personal de la clínica.',
        'consent.sms_label': 'Notificaciones por SMS',
        'consent.sms_text': 'Doy mi consentimiento para recibir mensajes de texto sobre mi evaluación y actualizaciones de consulta. Pueden aplicar tarifas de mensajes y datos.',
        'consent.optional_badge': 'opcional',
        'consent.submit_cta': 'Enviar Mi Evaluación ✓',
        'consent.submitting': 'Enviando…',
        'consent.disclaimer': 'Al enviar, confirmas que toda la información proporcionada es precisa y verdadera.',

        // Success
        'success.title': '¡Evaluación recibida!',
        'success.subtitle': 'Gracias. Tu evaluación impulsada por IA está en progreso.',
        'success.next_steps_heading': 'Qué pasa ahora',
        'success.step1_title': 'Análisis de IA',
        'success.step1_body': 'Nuestra IA está procesando tus fotos y respuestas del cuestionario para generar tu informe de evaluación personalizado.',
        'success.step2_title': 'Revisión del Coordinador',
        'success.step2_body': 'Un coordinador de la clínica revisará tu evaluación y se comunicará contigo dentro de 1 día hábil.',
        'success.step3_title': 'Tus Resultados',
        'success.step3_body': 'Recibirás tu informe de Hoja de Ruta de Belleza por correo electrónico una vez que tu evaluación esté completa.',

        // Footer
        'footer.hipaa_notice': 'Tu información está encriptada y protegida bajo HIPAA.',
        ...
        'error.invalid_email': 'Por favor ingresa una dirección de correo electrónico válida.',
        'error.turnstile': 'Por favor completa la verificación de seguridad para continuar.',
    },
};
